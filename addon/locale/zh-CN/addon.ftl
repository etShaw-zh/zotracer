...
activitylog-filter-file = 文件
activitylog-filter-tab = 标签页
activitylog-refresh = 刷新
activitylog-column-time = 时间
activitylog-column-action = 操作
activitylog-column-item = 条目
activitylog-column-source = 来源